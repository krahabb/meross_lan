...
PAYLOAD_GET = {
    ...
    NS_APPLIANCE_CONTROL_THERMOSTAT_ALARM: {KEY_ALARM: [{KEY_CHANNEL: 0}]},
    NS_APPLIANCE_CONTROL_THERMOSTAT_ALARMCONFIG: {KEY_ALARMCONFIG: [{KEY_CHANNEL: 0}]},
    ...
    NS_APPLIANCE_CONTROL_THERMOSTAT_CTLRANGE: {KEY_CTLRANGE: [{KEY_CHANNEL: 0}]},
    ...
    NS_APPLIANCE_CONTROL_THERMOSTAT_MODEB: {KEY_MODEB: []},
    ...
    NS_APPLIANCE_CONTROL_THERMOSTAT_SCHEDULEB: {KEY_SCHEDULEB: [{KEY_CHANNEL: 0}]},
    ...
    NS_APPLIANCE_CONTROL_THERMOSTAT_TIMER: {KEY_TIMER: [{KEY_CHANNEL: 0}]},
    NS_APPLIANCE_CONTROL_THERMOSTAT_WINDOWOPENED: {
...
# inferring the mts960 has the same mapping as mts200
MTS960_MODE_HEAT = 0
MTS960_MODE_COOL = 1
MTS960_MODE_ECO = 2  # this is the only value in our first trace
MTS960_MODE_AUTO = 3
MTS960_MODE_CUSTOM = 4
