...
PAYLOAD_GET = {
    ...
    NS_APPLIANCE_GARAGEDOOR_MULTIPLECONFIG: {KEY_CONFIG: []},
...
MTS200_OVERHEAT_WARNING_OVERHEAT = 1
MTS200_OVERHEAT_WARNING_NOTCONNECTED = 2
MTS200_OVERHEAT_WARNING_MAP = {
    MTS200_OVERHEAT_WARNING_OK: "ok",
    MTS200_OVERHEAT_WARNING_OVERHEAT: "overheat",
    MTS200_OVERHEAT_WARNING_NOTCONNECTED: "not connected",
}
