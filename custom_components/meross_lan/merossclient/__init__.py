...
class DeviceDescriptor:
    ...
    DYNAMIC_ATTRS = {
        ...
        mc.KEY_HARDWARE: lambda _self: _self.system.get(mc.KEY_HARDWARE, mn.EMPTY_DICT),
        mc.KEY_FIRMWARE: lambda _self: _self.system.get(mc.KEY_FIRMWARE, mn.EMPTY_DICT),
