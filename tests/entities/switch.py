...
class EntityTest(EntityComponentTest):
    ...
    # namespace
    DIGEST_ENTITIES = {
        mc.KEY_TOGGLEX: [switch.MLToggleX],
    }
    NAMESPACES_ENTITIES = {
        mn.Appliance_Config_Alarm: [siren.MLSiren.EnableSwitch],
        ...
        mn_t.Appliance_Control_Thermostat_ModeC: [
            switch.MLEmulatedSwitch,  # fan_hold_enable
        ],
        ...
        mn.Appliance_Control_Toggle: [switch.MLToggle],
        mn.Appliance_RollerShutter_Adjust: [rs.MLRollerShutterAdjustSwitch],
    }
    HUB_SUBDEVICES_ENTITIES = {
        mc.TYPE_MTS100: [switch.MLEmulatedSwitch],
        mc.TYPE_MTS100V3: [switch.MLEmulatedSwitch],
        mc.TYPE_MTS150: [switch.MLEmulatedSwitch, hub.HubBeep],
